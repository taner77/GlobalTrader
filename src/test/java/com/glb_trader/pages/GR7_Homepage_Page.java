...
public GR7_Homepage_Page(){PageFactory.initElements(Driver.getDriver(),this);}
    ...
    @FindBy(className = "img-responsive text-center_xs")
    ...
    @FindBy(xpath = "//*[@id=\"contact-us\"]/div[3]/div/div[1]/div/div[1]/strong")
