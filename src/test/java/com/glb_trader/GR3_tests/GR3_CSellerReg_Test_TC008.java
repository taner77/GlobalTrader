...
public class GR3_CSellerReg_Test_TC008 extends TestBase {
    // COMPANY SELLER PHONE bos birakildi login olmadi
    ...
    public void glbTraderHomePageTest() {
        ...
        String actualSellerMobilPhone = gr3_cSellerRegPage.sellerMobilPhone.getText();
        String expectedSellerMobilPhone = "";
        Assert.assertEquals(actualSellerMobilPhone,expectedSellerMobilPhone);

        System.out.println("COMPANY SELLER PHONE: " +gr3_cSellerRegPage.sellerMobilPhone.getText());
