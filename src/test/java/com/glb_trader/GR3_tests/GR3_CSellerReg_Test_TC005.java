...
public class GR3_CSellerReg_Test_TC005 extends TestBase {
    // Hem country hem de zip code bos birakildi login olmadi
    ...
    public void glbTraderHomePageTest() {
        ...
        System.out.println("ULKE SEC: " + select1.getFirstSelectedOption().getText());
