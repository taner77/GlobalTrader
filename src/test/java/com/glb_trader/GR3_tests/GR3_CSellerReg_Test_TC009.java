...
public class GR3_CSellerReg_Test_TC009 extends TestBase {
    // COMPANY PASSWORD bos birakildi login olmadi
    ...
    public void glbTraderHomePageTest() {
        ...
        String actualPassword = gr3_cSellerRegPage.password.getText();
        String expectedPassword = "";
        Assert.assertEquals(actualPassword,expectedPassword);

        System.out.println("COMPANY PASSWORD: " +gr3_cSellerRegPage.password.getText());
