...
public class GR3_CSellerReg_Test_TC007 extends TestBase {
    // COMPANY SELLER EMAIL bos birakildi login olmadi
    ...
    public void glbTraderHomePageTest() {
        ...
        String actualSellerEmail = gr3_cSellerRegPage.sellerEmail.getText();
        String expectedSellerEmail = "";
        Assert.assertEquals(actualSellerEmail,expectedSellerEmail);

        System.out.println("COMPANY SELLER EMAIL: " + gr3_cSellerRegPage.sellerEmail.getText());
