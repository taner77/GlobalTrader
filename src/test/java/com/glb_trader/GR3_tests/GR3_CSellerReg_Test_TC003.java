...
public class GR3_CSellerReg_Test_TC003 extends TestBase {
    // Zip code bos birakildi login olmadi
    ...
    public void glbTraderHomePageTest() {
        ...
        String actualZipCodeVerify = gr3_cSellerRegPage.postalCodeVerify.getText();
        String expectedZipCodeVerify = "Vender zip code is required.";
        Assert.assertEquals(actualZipCodeVerify,expectedZipCodeVerify);

        System.out.println("ZIP CODE VERIFY TEXT: "+ gr3_cSellerRegPage.postalCodeVerify.getText());
